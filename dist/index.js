...
var StyledIconBase = /*#__PURE__*/styled__default['default'](StyledIconBaseBase).withConfig({
...
var Send = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
...
var Refresh = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
    "xmlns": "http://www.w3.org/2000/svg"
  };
  return /*#__PURE__*/React__namespace.createElement(StyledIconBase, _extends({
    iconAttrs: attrs,
    iconVerticalAlign: "middle",
    iconViewBox: "0 0 24 24"
  }, props, {
...
var ChatDotsFill = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
    "xmlns": "http://www.w3.org/2000/svg"
  };
...
var EmojiSmile = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
    "xmlns": "http://www.w3.org/2000/svg"
  };
...
const Chat = styled__default['default'].div`
    display: flex;
...
`;
const ChatHeader = styled__default['default'].div`
    padding: 20px;
    width: 100%; 
...
`;
const ChatFooter = styled__default['default'].div`
    padding: 20px;
    width: 100%;
    height: 70px;
    ...
    align-items: center;
`;
const ChatText = styled__default['default'].div`
    color: ${props => props.theme.textColor};
    font-weight: bold;
    font-size: 20px;
`;
const ChatHeaderBox = styled__default['default'].div`
    display: flex;
    align-items: center;
    text-align: left;
`;
const IconsBox = styled__default['default'].div`
    min-width: 50px;
`;
const ErrorMessage = styled__default['default'].div`
    ...
    color: #fff;
`;
const EndMessage = styled__default['default'].div`
    display: flex;
    align-items: center;
    justify-content: center;
    width: 100%;
...
`;
const CloseIcon = styled__default['default'](Close)`
    color: ${props => props.theme.textColor};
    height: 15px;
    cursor: pointer;
    :hover {
...
`;
const MessageAvatar = styled__default['default'].img`
    width: 35px;
    height: 35px;   
    border-radius: 100%;   
    margin-right: 15px;
...
`;
const ShowMessage = styled__default['default'].div`    
    display: flex;   
`;
const CustomComponentContainer = styled__default['default'].div`    
    margin-bottom: 10px;   
`;
const CustomLoadingContainer = styled__default['default'].div`    
    margin-left: ${props => props.marginLeft}px; 
`;

const dotPulseBefore = props => styled.keyframes`
    0% {
...
const dotPulse = props => styled.keyframes`
    0% {
...
const dotPulseAfter = props => styled.keyframes`
    0% {
...
const Loading = styled__default['default'].div`
    position: relative;
    left: -9999px;
    margin-left: ${props => props.marginLeft}px;
    width: 5px;
...
const MessageContainer = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(Container$1, {
    isUser: isUser
  }, !showing ? loadingComponent ? /*#__PURE__*/React__default['default'].createElement(CustomLoadingContainer, {
    marginLeft: !src ? 50 : 0
  }, loadingComponent) : /*#__PURE__*/React__default['default'].createElement(Loading, {
    marginLeft: !src ? 70 : 20
  }) : /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(ShowMessage, {
    className: "lf-show-message"
  }, src ? /*#__PURE__*/React__default['default'].createElement(MessageAvatar, {
    alt: "Bot Avatar",
    src: src
  ...
  }), bubble ? (content || CustomComponent) && /*#__PURE__*/React__default['default'].createElement(Message, {
    isUser: isUser
  }, content, CustomComponent && renderCustomComponent()) : CustomComponent && /*#__PURE__*/React__default['default'].createElement(CustomComponentContainer, null, renderCustomComponent())), options && !disableOptions && /*#__PURE__*/React__default['default'].createElement(OptionsContainer, {
    className: "lf-show-message"
...
const Bot$1 = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(Chat, {
    style: positionStyles,
    width: width
  }, /*#__PURE__*/React__default['default'].createElement(ChatHeader, null, /*#__PURE__*/React__default['default'].createElement(ChatHeaderBox, null, /*#__PURE__*/React__default['default'].createElement(ChatText, null, header)), /*#__PURE__*/React__default['default'].createElement(IconsBox, null, /*#__PURE__*/React__default['default'].createElement(RefreshIcon, {
    onClick: handleResetChat
  }), /*#__PURE__*/React__default['default'].createElement(CloseIcon, {
    onClick: toggleOpen
  }))), /*#__PURE__*/React__default['default'].createElement(ChatBody, {
    id: "lf-chat-body"
  }, messages && messages.length > 0 && messages.map((message, index) => /*#__PURE__*/React__default['default'].createElement("div", {
    key: message.id
  }, renderMessage(message, index)))), /*#__PURE__*/React__default['default'].createElement(ChatFooter, {
    error: error
  }, end ? /*#__PURE__*/React__default['default'].createElement(EndMessage, null, endContent) : !error ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(ChatInput, {
    autoFocus: true,
  ...
  }, sendComponent ? sendComponent : /*#__PURE__*/React__default['default'].createElement(SendIcon, {
    disabled: disableSend()
  }))) : /*#__PURE__*/React__default['default'].createElement(ErrorMessage, null, error)));
};

const ChatClick = styled__default['default'].div`
    display: flex;
    align-items: center;
    justify-content: center;
    width: 50px;
    ...
    box-shadow: rgb(0 0 0 / 25%) 0px 12px 24px 0px;
`;
const ChatIcon = styled__default['default'](ChatDotsFill)`
  cursor: pointer;
  height: 20px;
  color: ${props => props.theme.textColor};    
`;
...
const IconContainer = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(ChatClick, {
    style: positionStyles
  }, /*#__PURE__*/React__default['default'].createElement(ChatIcon, null));
};
...
const Bot = ({
  ...
  }, buttonComponent) : /*#__PURE__*/React__default['default'].createElement(IconContainer, {
    toggleOpen: toggleOpen,
    style: style
  })));
};
...
const defaultOptions = {
  header: /*#__PURE__*/React__default['default'].createElement("span", null, "\uD83E\uDC85 API bot"),
  sendMessage: 'Type in your message...',
  endContent: /*#__PURE__*/React__default['default'].createElement("div", {
    style: {
      textAlign: 'center'
    }
  }, "Thank you for using ", /*#__PURE__*/React__default['default'].createElement("span", {
    style: {
      color: '#F652A0'
    }
  }, "\u2764"), /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, "\xA9 2021 ", /*#__PURE__*/React__default['default'].createElement("strong", null, "Lucas Fernando"), ".  All rights reserved.")),
  botAvatarSrc: img,
  open: false,
  hidden: false,
  messageDelay: 1000,
...
const defaultSteps = [{
  id: 'redirectUser',
  content: /*#__PURE__*/React__default['default'].createElement("span", null, "Welcome, human! Want to learn about my ", /*#__PURE__*/React__default['default'].createElement("strong", null, "\"props\""), "?"),
  options: [{
    content: /*#__PURE__*/React__default['default'].createElement("div", null, "\uD83E\uDD13 Yes"),
    value: 1,
    goTo: 2
  }, {
    content: /*#__PURE__*/React__default['default'].createElement("div", null, "\uD83D\uDE10 No"),
    value: 2,
    goTo: 3
  }]
}, {
  id: 2,
  content: /*#__PURE__*/React__default['default'].createElement("div", null, "Ok... You're going to be redirected in 5 seconds! See ya!"),
  end: true
}, {
  id: 3,
  content: /*#__PURE__*/React__default['default'].createElement("div", null, "Hummm..."),
  goTo: 4
}, {
  id: 4,
  content: /*#__PURE__*/React__default['default'].createElement("div", null, "Ok, See ya!"),
  end: true
}];
